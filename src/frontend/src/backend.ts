...
export class Backend implements backendInterface {
    ...
    async filterByGenre(arg0: string): Promise<Array<Game>> {
    ...
    async getPickOfTheDay(): Promise<Game> {
        if (this.processError) {
            try {
                const result = await this.actor.getPickOfTheDay();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchByTitle(arg0: string): Promise<Array<Game>> {
        if (this.processError) {
            try {
